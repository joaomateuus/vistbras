...
class VistoriasAgendadasActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_vistorias_agendadas)
    ...
    override fun onStart() {
        ...
        viewModel.sucessGetVistoriasAgendadas.observe(this, Observer {
    ...
    private fun setupUi() {
        this.adapter = VistoriaAgendadaItemAdapter {
            val intent = Intent(this, VistoriaAgendadaAcitivty::class.java)
        ...
        rvVistorias.layoutManager = LinearLayoutManager(this@VistoriasAgendadasActivity)
